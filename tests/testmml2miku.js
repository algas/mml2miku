...
describe("MIDIData", function () {
    ...
    describe("setVolume", function () {
        it("should return [0xB0,0x07,64]", function () {
            expect(midi.setVolume(64).msg).to.eql([0xB0, 0x07, 64]);
        });
    });

    describe("changeProgram", function () {
        it("should return [0xC0,3]", function () {
    ...
    describe("noteMsg", function () {
        it("should return [0x90,50,127]", function () {
            expect(midi.noteMsg(new MIDI.Note(4, null, 2), [])[0].msg).to.eql([0x90, 50, 127]);
        });
        it("should return [0x80,50,0]", function () {
